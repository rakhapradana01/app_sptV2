...
@php
    ...
    $variantMap = [
        ...
        'blue' => 'bg-blue-600 text-white shadow-sm hover:bg-blue-700 disabled:bg-blue-300',
        'yellow' => 'bg-yellow-400 text-yellow-900 shadow-sm hover:bg-yellow-500 disabled:bg-yellow-200',
        'red' => 'bg-red-600 text-white shadow-sm hover:bg-red-700 disabled:bg-red-300',
    ];
...
<button {{ $attributes->merge(['class' => $classes, 'type' => $attributes->get('type', 'submit')]) }}

...
<aside id="sidebar"
    ...
    <!-- Logo Section -->
    <div class="pt-8 pb-7 flex items-center justify-between gap-2.5"
        ...
        <a href="/" class="flex items-center gap-2">
            ...
            <span class="leading-5 text-lg font-semibold dark:text-white" x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen">Aplikasi <br> Perjalanan Dinas </span>
        </a>

        <!-- Mobile Close Button -->
        <button 
            @click="$store.sidebar.setMobileOpen(false)" 
            class="xl:hidden p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
